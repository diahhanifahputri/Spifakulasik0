        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" href="http://localhost/ci_login">Home</a>
                    </li>
                    <li>
    ...
    <!-- Header -->
        ...
        <div class="intro-text">
             <div class="intro-lead-in">Sistem Pendataan Kerusakan Infrastruktur dan Fasilitas Publik yang Rusak akibat Bencana</div>
                <a href="<?php echo base_url().'sign'?>" class="page-scroll btn btn-xl" >Sign In</a>
                <a href="<?php echo base_url().'register'?>" class="page-scroll btn btn-xl">Sign Up</a>
          </div>
        </div>
    </header>
