    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components" style="padding-top: 100px">
                ...
                <li>
                    <a href="crud/buatlaporan" style="color: black"><i><img src="<?php echo base_url().'assets/css/img/melapor.png'?>"> Tambah Laporan</i></a>
                </li>
            </ul>
        </nav>
        <!--  -->
...
<thead>
 ...
 <?php 
   ...
   <tr>
            ...
            <td>
              <?php echo anchor('crud/edit/'.$lap->id,'Edit'); ?>
