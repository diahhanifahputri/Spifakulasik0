    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components" style="padding-top: 100px">
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false">BPDB</a>
                </li>
                <li>
                    <a href="<?php echo base_url().'crud'?>" style="color: black"><i><img src="<?php echo base_url().'assets/css/img/list.png'?>"></i> Lihat Laporan</a>
                </li>
                <li>
                    <a href="inputdinas" ><i><img src="<?php echo base_url().'assets/css/img/cek.png'?>"> Pilih Dinas dan Jadwal </i></a>
                </li>
            </ul>
        </nav>
        <!--  -->
...
<thead>
  <tr>
    ...
    <th scope="col">Jadwal kunjungan</th>
     ...
     <th scope="col">1</th>
     <th scope="col">Dinas 1</th>
    <th scope="col">Senin - Rabu</th>
        
   <tr>
     </tr>
     <th scope="col">2</th>
     <th scope="col">Dinas 2</th>
    <th scope="col">Kamis - Jumat</th>
        
   <tr>
        </tr>
     <th scope="col">3</th>
     <th scope="col">Dinas 3</th>
    <th scope="col">Sabtu - Minggu</th>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-dark bg-dark navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="http://localhost/ci_login"> SPIFAKULASIK </a>
            </div>
