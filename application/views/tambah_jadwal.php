...
<div class="container" style="padding-top: 100px">
    <div class="card">
        ...
        <div class="card-header">
            <h3 style="text-align: center;">Tambah Jadwal</h3>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <form action="<?php echo base_url(). 'crud/update'; ?>" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" name="namaLaporan" value="<?php echo $lap->namaLaporan ?>" style="width: 200%"></td>
                    </tr>
                    <tr>
                        <td width="250"><b>Jenis Infrastruktur</b><span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="jenisInfra" value="<?php echo $lap->jenisInfra ?>" style="width: 200%"></td>
                    </tr>
                    <tr>
                        <td><b>Kerusakan yang Terjadi</b><span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="kerusakan" value="<?php echo $lap->kerusakan ?>" style="width: 200%"></td>
                    </tr>
                    <tr>
                        <td><b>Bencana yang Menyebabkan</b><span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="penyebabB" value="<?php echo $lap->penyebabB ?>" style="width: 200%"></td>
                    </tr>
                    <tr>
                        <td><b>Keterbatasan Pemanfaatan</b><span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="keterbatasan" value="<?php echo $lap->keterbatasan ?>" style="width: 200%"></td>
                    </tr>  
                     <tr>
                        <td><b>Tambah Jadwal</b><span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="gambar" value="" style="width: 200%"></td>
                    </tr>  
                    <tr> 
                    <td>  
