    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                     <form class="form-signin" action="<?php echo base_url().'register/register'?>" method="post">
                        <input type="hidden" name="_token" value="FaSMf6fNuyZLnpYpKsIfepY4zicnNU0SXOE8ZNp8">
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Name</label>

                            <div class="col-md-6">
                                <input id="namaP" type="text" class="form-control" name="namaP" value="" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="emailP" value="" required>

                                                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">No KTP</label>

                            <div class="col-md-6">
                                <input id="noKtp" type="text" class="form-control" name="noKtp" value="" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="passwordP" required>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                                        <li>
                        <a class="page-scroll" href="http://localhost:8000">Home</a>
                    </li>
                    <li>
