    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components" style="padding-top: 100px">
                ...
                <li>
                    <a href="<?php echo base_url().'crud'?>" style="color: black"><i><img src="<?php echo base_url().'assets/css/img/list.png'?>"></i> Lihat Laporan</a>
                </li>
                <li>
                    <a href="<?php echo base_url().'crud/prioritas'?>" style="color: black"><i><img src="<?php echo base_url().'assets/css/img/cek.png'?>"> Urut Prioritas</i></a>
                </li>
            </ul>
        </nav>
        <!--  -->
...
<thead>
  ...
  <tr>
    <th scope="col">1</th>
     <th scope="col">bangunan sekolah</th>
    <th scope="col">bangunan</th>
    <th scope="col">bangunan kelas roboh</th>
    <th scope="col">gempa bumi</th>
    <th scope="col">hanya 1 kelas yang bisa dipakai</th>
  </tr>
  <tr>
    <th scope="col">2</th>
     <th scope="col">Perumahan sekarpetak</th>
    <th scope="col">bangunan rumah</th>
    <th scope="col">tertimbun</th>
    <th scope="col">tanah longsor</th>
    <th scope="col">perkarangan perumahan di sebelah barat</th>
  </tr>
  <tr>
    <th scope="col">3</th>
     <th scope="col">kebakaran pasar sinanjul</th>
    <th scope="col">sebagian tempat berjualan tidak bisa untuk berjualan</th>
    <th scope="col">sebagian kanan wilayah pasar rusak terbakar</th>
    <th scope="col">kebakaran</th>
    <th scope="col">sebagian kiri pasar bisa untuk berjualan</th>
  </tr>
</thead>
<tbody>
  </tbody>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-dark bg-dark navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="http://localhost:8000"> SPIFAKULASIK </a>
            </div>
