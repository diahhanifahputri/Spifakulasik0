...
<thead>
  ...
  <?php 
   ...
   <tr>
            <td><?php echo $no++ ?></td>
            <td><?php echo $lap->namaLaporan ?></td>
            <td><?php echo $lap->jenisInfra ?></td>
            <td><?php echo $lap->kerusakan ?></td>
            <td><?php echo $lap->penyebabB ?></td>
            <td><?php echo $lap->keterbatasan ?></td>
            <td><?php echo $lap->gambar ?></td>
            <td><?php echo $lap->lokasi ?></td>
            <td>
              <?php echo anchor('crud/tambah_jadwal'.$lap->id,'Tambah Jadwal'); ?>
              <?php echo anchor('crud/hapus/'.$lap->id,'Hapus'); ?>   
            </td>
          </tr>
        <?php } ?>
